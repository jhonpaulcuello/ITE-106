...
public class PhonebookSystem extends JFrame implements ActionListener {
    ...
    private JPanel createInputPanel() {
        ...
        inputPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(Color.WHITE), "Add or Search Contact",
    ...
    private JPanel createTextAreaPanel() {
        ...
        textAreaPanel.setBorder(BorderFactory.createTitledBorder(
            BorderFactory.createLineBorder(Color.WHITE), "Contacts",
            TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION,
            new Font("Arial", Font.BOLD, 14), Color.WHITE));
        ...
        contactArea.setBackground(Color.BLACK); 
        contactArea.setForeground(Color.WHITE); 
        contactArea.setBorder(BorderFactory.createLineBorder(Color.WHITE)); 
